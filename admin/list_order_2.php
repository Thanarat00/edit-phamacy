  ...
  <tbody>
    ...
    <tr>
     ...
     <td>
      ...
      <a href="user2.php?order_id=<?php echo $rs_order['order_id'];?>&act=view" target="" class="btn btn-success btn-xs"><i class="nav-icon fas fa-clipboard-list"></i> เปิดดูรายการ</a>
