...
order_id, WEEK(order_date) AS datesave,
SUM(pay_amount) AS ptotal
FROM tbl_order 
WHERE order_status =4

GROUP BY WEEK(order_date) DESC
ORDER BY WEEK(order_date) DESC
...
?>
    ...
    <div class="card card-gray">
            <div class="card-header ">
              <h3 class="card-title">ยอดขายรายสัปดาห์</h3>
                ...
                <table class="table" id="datatable" >
                              ...
                              <?php
                                  foreach($rs_my_order as $rs_order){
                                      echo"<tr>";
                                          ...
                                          echo "<td>สัปดาห์ที่ ".$rs_order['datesave']."</td>";
                  ...
                  $(function () {
                      ...
                      $('#container').highcharts({
                          ...
                          title: {
                              text: 'รายงานภาพรวมยอดขายรายสัปดาห์',
                                style: {
                              //color: '#fff'
